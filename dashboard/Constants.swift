...
let avaxSettings = PairSettings(leverage: 4, minimumOrderVolume: 1, priceFractionalPoints: 3, volumeFractionalPoints: 0, averageVolume: 10000)

enum Constants {
    static let bookDepth = 25
    static let defaultPair = "MATIC/USDT"
    static let pairs = ["AVAX/USDT","MATIC/USDT", "MANA/USDT", "ETH/USDT", "ADA/USDT"]
