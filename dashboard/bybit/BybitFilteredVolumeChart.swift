...
struct BybitFilteredVolumeChart: View {
        ...
        HStack {
            ...
            VStack {
                VStack {
                    ZStack {
                        HStack(spacing: 0) {
                            Rectangle().fill(Color("GreenLight")).frame(width: cellWidth - Double(totalAskCellWidth5), height: 25)
                            Rectangle().fill(Color("RedLight")).frame(width: totalAskCellWidth5, height: 25)
                ...
                VStack {
                    ZStack {
                        HStack(spacing: 0) {
                            Rectangle().fill(Color("GreenLight")).frame(width: cellWidth - totalAskCellWidth10, height: 25)
                            Rectangle().fill(Color("RedLight")).frame(width: totalAskCellWidth10, height: 25)
                ...
                VStack {
                    ZStack {
                        HStack(spacing: 0) {
                            Rectangle().fill(Color("GreenLight")).frame(width: cellWidth - totalAskCellWidth, height: 25)
                            Rectangle().fill(Color("RedLight")).frame(width: totalAskCellWidth, height: 25)
